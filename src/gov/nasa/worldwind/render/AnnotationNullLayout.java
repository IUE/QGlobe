...
public class AnnotationNullLayout extends AbstractAnnotationLayout
{
    ...
    public com.qq.java.awt.Dimension getPreferredSize(DrawContext dc, Iterable<? extends Annotation> annotations)
    {
        if (dc == null)
        {
        ...
        com.qq.java.awt.Rectangle annotationBounds = new com.qq.java.awt.Rectangle();

        for (Annotation annotation : annotations)
        {
            com.qq.java.awt.Rectangle b = this.getAnnotationBounds(dc, annotation);
            if (b != null)
            {
    ...
    public void drawAnnotations(DrawContext dc, com.qq.java.awt.Rectangle bounds,
        Iterable<? extends Annotation> annotations, double opacity, Position pickPosition)
    {
        ...
        for (Annotation annotation : annotations)
        {
            com.qq.java.awt.Rectangle annotationBounds = this.getAnnotationBounds(dc, annotation);
    ...
    protected com.qq.java.awt.Rectangle getAnnotationBounds(DrawContext dc, Annotation annotation)
    {
        com.qq.java.awt.Dimension size = this.getAnnotationSize(dc, annotation);
        if (size == null)
            return null;

        com.qq.java.awt.Point offset = annotation.getAttributes().getDrawOffset();
        if (offset == null)
            offset = new com.qq.java.awt.Point();

        return new com.qq.java.awt.Rectangle(offset, size);
    }

    @SuppressWarnings({"UnusedDeclaration"})
    protected com.qq.java.awt.Rectangle adjustAnnotationBounds(DrawContext dc, com.qq.java.awt.Rectangle parentBounds,
        Annotation annotation, com.qq.java.awt.Rectangle bounds)
    {
        int x = bounds.x;
        int y = bounds.y;
        ...
        return new com.qq.java.awt.Rectangle(x, y, bounds.width, bounds.height);
    }
}
