 ...
 * The source can be either a path to a valid image file, or a {@link com.qq.java.awt.image.BufferedImage}. By default,
 ...
 * background image may be translated or scaled by setting the attributes {@link gov.nasa.worldwind.render.AnnotationAttributes#setImageOffset(com.qq.java.awt.Point)}
...
public abstract class AbstractAnnotation extends AVListImpl implements Annotation
{
    ...
    protected java.util.Map<Object, com.qq.java.awt.Rectangle> textBoundsMap;
    ...
    protected AbstractAnnotation()
    {
        ...
        this.textBoundsMap = new java.util.HashMap<Object, com.qq.java.awt.Rectangle>();
    }
    ...
    public com.qq.java.awt.Dimension getPreferredSize(DrawContext dc)
    {
        if (dc == null)
        {
            String message = Logging.getMessage("nullValue.DrawContextIsNull");
        ...
        com.qq.java.awt.Dimension size = new com.qq.java.awt.Dimension(this.getAttributes().getSize());
        if (size.width < 1)
            size.width = 1;
        if (size.height < 0)
            size.height = 0;
        ...
        com.qq.java.awt.Rectangle insetBounds = this.computeInsetBounds(size.width, size.height);
        com.qq.java.awt.Dimension insetSize = new com.qq.java.awt.Dimension(insetBounds.width, insetBounds.height);
        ...
        com.qq.java.awt.Insets insets = this.getAttributes().getInsets();
        return new com.qq.java.awt.Dimension(
    ...
    protected void applyScreenTransform(DrawContext dc, int x, int y, int width, int height, double scale)
    {
        ...
        com.qq.java.awt.Point offset = this.getAttributes().getDrawOffset();
    ...
    /**
     * Get the annotation bounding {@link com.qq.java.awt.Rectangle} using OGL coordinates - bottom-left corner x and y
     ...
     * @param dc the current DrawContext.
     *
     * @return the annotation bounding {@link com.qq.java.awt.Rectangle} using OGL viewport coordinates.
     *
     * @throws IllegalArgumentException if <code>dc</code> is null.
     */
    public com.qq.java.awt.Rectangle getBounds(DrawContext dc)
    {
        if (dc == null)
        {
            String message = Logging.getMessage("nullValue.DrawContextIsNull");
        ...
        WWTexture texture)
    {
        ...
        this.applyColor(dc, com.qq.java.awt.Color.WHITE, imageOpacity, true);
    }
        ...
        WWTexture texture)
    {
        ...
        com.qq.java.awt.Point imageOffset = this.getAttributes().getImageOffset();
        if (imageOffset != null)
        {
    ...
    protected void drawText(DrawContext dc, int width, int height, double opacity, Position pickPosition)
    {
        ...
        com.qq.java.awt.Rectangle insetBounds = this.computeInsetBounds(width, height);
        ...
        if (dc.isPickingMode())
        {
            ...
            com.qq.java.awt.Rectangle screenInsetBounds = this.transformByModelview(dc, insetBounds);
            com.qq.java.awt.Point glPickPoint = this.glPointFromAWTPoint(dc, dc.getPickPoint());
        ...
        com.qq.java.awt.Rectangle wrappedTextBounds = this.getTextBounds(dc, wrappedText, attribs.getFont(),
            attribs.getTextAlign());
        ...
        Position pickPosition, String text)
    {
        ...
        com.qq.java.awt.Color textColor = this.modulateColorOpacity(attribs.getTextColor(), opacity);
        com.qq.java.awt.Color backColor = this.modulateColorOpacity(attribs.getBackgroundColor(), opacity);
    ...
    @SuppressWarnings({"UnusedDeclaration"})
    protected void doDrawChildren(DrawContext dc, com.qq.java.awt.Rectangle bounds, double opacity, Position pickPosition)
    {
    ...
    @SuppressWarnings({"UnusedDeclaration"})
    protected void beginDrawChildren(DrawContext dc, com.qq.java.awt.Rectangle bounds)
    {
    ...
    {
        com.qq.java.awt.Color color = dc.getUniquePickColor();
    ...
    protected void drawCallout(DrawContext dc, int mode, int width, int height, boolean useTexCoords)
    {
        ...
        com.qq.java.awt.Point offset = this.getAttributes().getDrawOffset();
        com.qq.java.awt.Point leaderOffset = new com.qq.java.awt.Point((width / 2) - offset.x, -offset.y);
    ...
    protected void applyColor(DrawContext dc, com.qq.java.awt.Color color, double opacity, boolean premultiplyColors)
    {
        if (dc.isPickingMode())
            return;
    ...
    protected com.qq.java.awt.Color modulateColorOpacity(com.qq.java.awt.Color color, double opacity)
    {
        float[] compArray = new float[4];
        color.getRGBComponents(compArray);
        compArray[3] *= (float) opacity;

        return new com.qq.java.awt.Color(compArray[0], compArray[1], compArray[2], compArray[3]);
    }

    protected com.qq.java.awt.Rectangle transformByModelview(DrawContext dc, com.qq.java.awt.Rectangle rectangle)
    {
        ...
        return new com.qq.java.awt.Rectangle((int) origin.x, (int) origin.y, (int) size.x, (int) size.y);
    }

    protected com.qq.java.awt.Point glPointFromAWTPoint(DrawContext dc, com.qq.java.awt.Point awtPoint)
    {
        if (dc.getView() == null || dc.getView().getViewport() == null)
            return null;

        com.qq.java.awt.Rectangle viewport = dc.getView().getViewport();
        return new com.qq.java.awt.Point(awtPoint.x, viewport.height - awtPoint.y - 1);
    }
    ...
    protected TextRenderer getTextRenderer(DrawContext dc, com.qq.java.awt.Font font)
    {
        return OGLTextRenderer.getOrCreateTextRenderer(dc.getTextRendererCache(), font);
    }

    protected MultiLineTextRenderer getMultiLineTextRenderer(DrawContext dc, com.qq.java.awt.Font font, String align)
    {
...
//        mltr.setLineSpacing(-2);
    ...
    protected String getWrappedText(DrawContext dc, int width, int height, String text, com.qq.java.awt.Font font,
        String align)
    {
    ...
    protected com.qq.java.awt.Rectangle getTextBounds(DrawContext dc, String text, com.qq.java.awt.Font font, String align)
    {
        Object key = new TextCacheKey(0, 0, text, font, align);
        com.qq.java.awt.Rectangle bounds = this.textBoundsMap.get(key);
        if (bounds == null)
        {
        ...
        return new com.qq.java.awt.Rectangle(bounds);
    }

    protected String wrapText(DrawContext dc, int width, int height, String text, com.qq.java.awt.Font font, String align)
    {
        if (text.length() > 0)
        {
    ...
    protected com.qq.java.awt.Rectangle computeTextBounds(DrawContext dc, String text, com.qq.java.awt.Font font, String align)
    {
        if (text.length() > 0)
        {
            MultiLineTextRenderer mltr = this.getMultiLineTextRenderer(dc, font, align);
        ...
        {
            return new com.qq.java.awt.Rectangle();
        }
    }
    ...
    protected static class TextCacheKey
    {
        ...
        private final com.qq.java.awt.Font font;
        private final String align;

        public TextCacheKey(int width, int height, String text, com.qq.java.awt.Font font, String align)
        {
            this.width = width;
            this.height = height;
            this.text = text;
    ...
    protected com.qq.java.awt.Rectangle computeInsetBounds(int width, int height)
    {
        ...
        return new com.qq.java.awt.Rectangle(insets.left, insets.bottom, insetWidth, insetHeight);
    }

    protected com.qq.java.awt.Rectangle computeFreeBounds(DrawContext dc, int width, int height)
    {
        AnnotationAttributes attribs = this.getAttributes();

        // Start with the inset bounds.
        com.qq.java.awt.Rectangle bounds = computeInsetBounds(width, height);
        ...
        String wrappedText = this.getWrappedText(dc, width, height, this.getText(), attribs.getFont(),
            attribs.getTextAlign());
        com.qq.java.awt.Rectangle textBounds = this.getTextBounds(dc, wrappedText, attribs.getFont(),
            attribs.getTextAlign());
    ...
    protected com.qq.java.awt.Dimension adjustSizeToText(DrawContext dc, int width, int height)
    {
        AnnotationAttributes attribs = this.getAttributes();

        String text = this.getWrappedText(dc, width, height, this.getText(), attribs.getFont(), attribs.getTextAlign());
        com.qq.java.awt.Rectangle textBounds = this.getTextBounds(dc, text, attribs.getFont(), attribs.getTextAlign());
        ...
        return new com.qq.java.awt.Dimension(width, height);
    }

    protected com.qq.java.awt.Dimension adjustSizeToChildren(DrawContext dc, int width, int height)
    {
        if (this.layoutManager != null)
        {
            com.qq.java.awt.Dimension preferredSize = this.layoutManager.getPreferredSize(dc, this.childList);
