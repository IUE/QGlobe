...
public abstract class AbstractAnnotationLayout implements AnnotationLayoutManager
{
    ...
    public void beginDrawAnnotations(DrawContext dc, com.qq.java.awt.Rectangle bounds)
    {
        if (dc == null)
        {
    ...
    protected com.qq.java.awt.Dimension getAnnotationSize(DrawContext dc, Annotation annotation)
    {
        try
        {
