...
public class Sector implements Cacheable, Comparable<Sector>, Iterable<LatLon>
{
     ...
     * com.qq.java.awt.geom.Rectangle2D} in degrees lat-lon coordinates where x corresponds to longitude and y to latitude. The
     ...
     * @return the new <code>Sector</code>
     */
    public static Sector fromDegrees(com.qq.java.awt.geom.Rectangle2D rectangle)
    {
    ...
    public static Sector[] splitBoundingSectors(Globe globe, LatLon center, double radius)
    {
        ...
        Iterable<? extends LatLon> locations = com.qq.java.util.Arrays.asList(ll, ur);
    ...
    /**
     * Returns a {@link com.qq.java.awt.geom.Rectangle2D} corresponding to this Sector in degrees lat-lon coordinates where x
     * corresponds to longitude and y to latitude.
     *
     * @return a {@link com.qq.java.awt.geom.Rectangle2D} corresponding to this Sector in degrees lat-lon coordinates.
     */
