...
public class ViewUtil
{
    ...
    public static Line computeRayFromScreenPoint(View view, double x, double y,
        Matrix modelview, Matrix projection, com.qq.java.awt.Rectangle viewport)
    {
    ...
    public static double computePixelSizeAtDistance(double distance, Angle fieldOfView, com.qq.java.awt.Rectangle viewport)
    {
        if (fieldOfView == null)
        {
            String message = Logging.getMessage("nullValue.AngleIsNull");
     ...
     */
    public static Angle computeVerticalFieldOfView(Angle horizontalFieldOfView, com.qq.java.awt.Rectangle viewport)
    {
     ...
     *                                  rectangle are null.
     */
    public static Vec4 project(Vec4 modelPoint, Matrix modelview, Matrix projection, com.qq.java.awt.Rectangle viewport)
    {
        if (modelPoint == null)
        {
     ...
     *                                  rectangle are null.
     */
    public static Vec4 unProject(Vec4 windowPoint, Matrix modelview, Matrix projection, com.qq.java.awt.Rectangle viewport)
    {
        if (windowPoint == null)
        {
            String message = Logging.getMessage("nullValue.PointIsNull");
