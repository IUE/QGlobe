 ...
 *
 * @author jym
 * @version $Id: BasicView.java 1 2011-07-16 23:22:47Z dcollins $
 */
public class BasicView extends WWObjectImpl implements View
{
    ...
    protected com.qq.java.awt.Rectangle viewport = new com.qq.java.awt.Rectangle();
    ...
    public com.qq.java.awt.Rectangle getViewport()
    {
        // java.awt.Rectangle is mutable, so we defensively copy the viewport.
        return new com.qq.java.awt.Rectangle(this.viewport);
    }
     ...
     */
    public Vec4 project(Vec4 point, Matrix modelview, Matrix projection, com.qq.java.awt.Rectangle viewport)
    {
        if (point == null)
        {
            String message = Logging.getMessage("nullValue.PointIsNull");
     ...
     */
    public Vec4 unProject(Vec4 windowPoint, Matrix modelview, Matrix projection, com.qq.java.awt.Rectangle viewport)
    {
        if (windowPoint == null)
        {
            String message = Logging.getMessage("nullValue.PointIsNull");
