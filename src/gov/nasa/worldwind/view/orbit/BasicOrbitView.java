...
public class BasicOrbitView extends BasicView implements OrbitView
{
    ...
    protected void doApply(DrawContext dc)
    {
        ...
        //BBB - Query doesn't work on andriod
        viewportArray[2]=dc.getDrawableWidth();
        viewportArray[3]=dc.getDrawableHeight();
        this.viewport = new com.qq.java.awt.Rectangle(viewportArray[0], viewportArray[1], viewportArray[2], viewportArray[3]);
