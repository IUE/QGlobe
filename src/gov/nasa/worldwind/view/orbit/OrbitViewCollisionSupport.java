...
public class OrbitViewCollisionSupport
{
    ...
    private double computeViewHeightAboveSurface(DrawContext dc, Matrix modelviewInv,
        Angle fieldOfView, com.qq.java.awt.Rectangle viewport, double nearDistance)
    {
    ...
    private Vec4 getPointOnNearPlane(Matrix modelviewInv, Angle fieldOfView, com.qq.java.awt.Rectangle viewport,
        double nearDistance)
    {
