...
/**
 * @author tag
 * @version $Id: AbstractLayer.java 1 2011-07-16 23:22:47Z dcollins $
 */
public abstract class AbstractLayer extends WWObjectImpl implements Layer
{
    ...
    public void pick(DrawContext dc, com.qq.java.awt.Point point)
    {
        if (!this.enabled)
            return; // Don't check for arg errors if we're disabled
    ...
    protected void doPick(DrawContext dc, com.qq.java.awt.Point point)
    {
