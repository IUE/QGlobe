...
public class PlaceNameLayer extends AbstractLayer implements BulkRetrievable
{
    ...
    protected static class PlaceNameChunk implements Cacheable
    {
        ...
        protected CharSequence getText(int index)
        {
            ...
            int endIndex = (index + 1 < numEntries) ? textIndexArray[index + 1] : textArray.limit();
            //TODO - BBB - this doesn't work on android?
//            return this.textArray.subSequence(beginIndex, endIndex); 
            int charlen = endIndex - beginIndex;
            char[] charArray = new char[charlen];
            textArray.position(beginIndex);
            textArray.get(charArray, 0, charlen);
