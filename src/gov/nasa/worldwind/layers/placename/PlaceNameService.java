...
public class PlaceNameService
{
    ...
    private com.qq.java.awt.Color color;
    private com.qq.java.awt.Color backgroundColor;
    ...
    public PlaceNameService(String service, String dataset, String fileCachePath, Sector sector, LatLon tileDelta,
    		com.qq.java.awt.Font font, boolean versionTag)
    {
        // Data retrieval and caching attributes.
        ...
        this.font = font;
        this.enabled = true;
        this.color = com.qq.java.awt.Color.white;
    ...
    public synchronized final com.qq.java.awt.Color getColor()
    {
        return this.color;
    }
    ...
    public final com.qq.java.awt.Font getFont()
    {
        return this.font;
    }
     ...
     */
    public synchronized final void setColor(com.qq.java.awt.Color color)
    {
        if (color == null)
        {
    ...
    public synchronized final void setBackgroundColor(com.qq.java.awt.Color backgroundColor)
    {
