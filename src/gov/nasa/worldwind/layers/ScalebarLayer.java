...
import com.qq.java.awt.geom.*;

/**
 * Renders a scalebar graphic in a screen corner.
 * 
 * @author Patrick Murris
 * @version $Id: ScalebarLayer.java 1 2011-07-16 23:22:47Z dcollins $
 */
public class ScalebarLayer extends AbstractLayer
{
    ...
    public void draw(DrawContext dc)
    {
            ...
            if(referencePosition != null)
            {
                ...
                if (!Double.isNaN(pot))
                {
                    ...
                    if (!dc.isPickingMode())
                    {
                        ...
                        gl.glColor4f(colorRGB[0], colorRGB[1], colorRGB[2], (float)(backColor.getAlpha() / 255d
                            * this.getOpacity()));
                        gl.glTranslatef((float)((width - divWidth) / 2), 0f, 0f);
                        ...
                        gl.glTranslatef((float)(-1d / scale), (float)(1d / scale), 0f);
                        this.drawScale(dc, divWidth, height);
        ...
        {
            gl.glColor4f(1f, 1f, 1f, 1f); // restore the default OpenGL color
...
//        gl.glEnd();
    ...
    private void drawScale(DrawContext dc, double width, double height)
    {
        ...
        vertexBuf = BufferUtil.newFloatBuffer(verts.length);
        vertexBuf.put(verts);
        vertexBuf.rewind();
        gl.glVertexPointer(3, GL.GL_FLOAT, 0, vertexBuf);
        gl.glDrawArrays(GL.GL_LINE_STRIP, 0, verts.length / 3);
...
//        gl.glEnd();
	...
	private double computeScale(com.qq.java.awt.Rectangle viewport)
	{
	...
	private Vec4 computeLocation(com.qq.java.awt.Rectangle viewport, double scale)
	{
