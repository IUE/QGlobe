...
public class ImageIORasterWriter extends AbstractDataRasterWriter
{
    ...
    {
        super(com.qq.javax.imageio.ImageIO.getWriterMIMETypes(), getImageIOWriterSuffixes());
    ...
    protected void writeImage(DataRaster raster, String formatSuffix, java.io.File file) throws java.io.IOException
    {
        ...
        com.qq.java.awt.image.BufferedImage image = bufferedImageRaster.getBufferedImage();
        com.qq.javax.imageio.ImageIO.write(image, formatSuffix, file);
    }
    ...
    {
//TODO: BBB - Only support png right now
//        java.util.Iterator<com.qq.javax.imageio.spi.ImageWriterSpi> iter;
//        try
//        {
