...
public class MipMappedBufferedImageRaster extends BufferedImageRaster
{
     ...
     */
    public MipMappedBufferedImageRaster(Sector sector, com.qq.java.awt.image.BufferedImage image)
    {
        super(sector, image);

        int maxLevel = ImageUtil.getMaxMipmapLevel(image.getWidth(), image.getHeight());
        com.qq.java.awt.image.BufferedImage[] levelImages = ImageUtil.buildMipmaps(image,
        		com.qq.java.awt.image.BufferedImage.TYPE_INT_ARGB_PRE, maxLevel);
     ...
     */
    public MipMappedBufferedImageRaster(Sector sector, com.qq.java.awt.image.BufferedImage[] images)
    {
