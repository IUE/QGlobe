...
//                throw new IllegalArgumentException(message);
    ...
    protected com.qq.java.awt.Rectangle computeClipRect(Sector clipSector, DataRaster clippedRaster)
    {
        com.qq.java.awt.geom.AffineTransform geographicToRaster = this.computeGeographicToRasterTransform(
            clippedRaster.getWidth(), clippedRaster.getHeight(), clippedRaster.getSector());

        com.qq.java.awt.geom.Point2D geoPoint = new com.qq.java.awt.geom.Point2D.Double();
        com.qq.java.awt.geom.Point2D ul = new com.qq.java.awt.geom.Point2D.Double();
        com.qq.java.awt.geom.Point2D lr = new com.qq.java.awt.geom.Point2D.Double();
        ...
        return new com.qq.java.awt.Rectangle(x, y, width, height);
    }
