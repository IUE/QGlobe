...
public abstract class BufferedDataRaster extends AbstractDataRaster
{
    ...
    public void fill(double value)
    {
        ...
        com.qq.java.util.Arrays.fill(samples, value);
    ...
    protected void doDrawOnCanvas(BufferedDataRaster canvas, Sector clipSector)
    {
        ...
        com.qq.java.awt.geom.AffineTransform canvasToThis = this.computeSourceToDestTransform(
        ...
        com.qq.java.awt.Rectangle clipRect = new com.qq.java.awt.Rectangle(0, 0, canvasWidth - 1, canvasHeight - 1);
        if (clipSector != null)
        {
            com.qq.java.awt.Rectangle rect = this.computeClipRect(clipSector, canvas);
    ...
    @Override
    protected com.qq.java.awt.geom.AffineTransform computeSourceToDestTransform(
        ...
        int destWidth, int destHeight, Sector destSector)
    {
        ...
        com.qq.java.awt.geom.AffineTransform transform = new com.qq.java.awt.geom.AffineTransform();
    ...
    @Override
    protected com.qq.java.awt.geom.AffineTransform computeGeographicToRasterTransform(int width, int height, Sector sector)
    {
    ...
    private static class InterpolantLookupTable
    {
        ...
        public InterpolantLookupTable(int width, int height)
        {
            ...
            com.qq.java.util.Arrays.fill(this.xParams, -1d);
            com.qq.java.util.Arrays.fill(this.yParams, -1d);
        }
    ...
    private InterpolantLookupTable createLookupTable(int width, int height,
        double xMin, double xMax, double yMin, double yMax, com.qq.java.awt.geom.AffineTransform lookupTransform)
    {
        ...
        com.qq.java.awt.geom.Point2D thisPoint = new com.qq.java.awt.geom.Point2D.Double();
        com.qq.java.awt.geom.Point2D canvasPoint = new com.qq.java.awt.geom.Point2D.Double();
        double x, y;
        int index;
