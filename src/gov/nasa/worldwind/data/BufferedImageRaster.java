...
import com.qq.java.awt.RenderingHints;
import com.qq.java.awt.geom.Rectangle2D;
import com.qq.java.awt.image.AffineTransformOp;
...
{
    private com.qq.java.awt.image.BufferedImage bufferedImage;
    private com.qq.java.awt.Graphics2D g2d;

    public BufferedImageRaster(Sector sector, com.qq.java.awt.image.BufferedImage bufferedImage)
    {
        this(sector, bufferedImage, null);
    }

    public BufferedImageRaster(Sector sector, com.qq.java.awt.image.BufferedImage bufferedImage, AVList list)
    {
    ...
    public com.qq.java.awt.image.BufferedImage getBufferedImage()
    {
        return this.bufferedImage;
    }

    public com.qq.java.awt.Graphics2D getGraphics()
    {
        if (this.g2d == null)
        {
            this.g2d = this.bufferedImage.createGraphics();
            // Enable bilinear interpolation.
            this.g2d.setRenderingHint(com.qq.java.awt.RenderingHints.KEY_INTERPOLATION,
            		com.qq.java.awt.RenderingHints.VALUE_INTERPOLATION_BILINEAR);
        }
        return g2d;
    }
    ...
    public void fill(com.qq.java.awt.Color color)
    {
        if (color == null)
        {
        ...
        com.qq.java.awt.Graphics2D g2d = this.getGraphics();

        // Keep track of the previous color.
        com.qq.java.awt.Color prevColor = g2d.getColor();
        try
        {
    ...
    {
        long size = 0L;
        com.qq.java.awt.image.Raster raster = this.bufferedImage.getRaster();
        if (raster != null)
        {
        	com.qq.java.awt.image.DataBuffer db = raster.getDataBuffer();
            if (db != null)
            {
...
//    }
    ...
    protected void doDrawOnTo(BufferedImageRaster canvas)
    {
        ...
        com.qq.java.awt.Graphics2D g2d = null;
        com.qq.java.awt.Shape prevClip = null;
        com.qq.java.awt.Composite prevComposite = null;
        ...
        try
        {
            ...
            // Apply the transform that correctly maps the image onto the canvas.
            com.qq.java.awt.geom.AffineTransform transform = this.computeSourceToDestTransform(
                    this.getWidth(), this.getHeight(), this.getSector(), canvasWidth, canvasHeight, canvas.getSector());
            ...
            // Set the alpha composite for appropriate alpha blending.
            g2d.setComposite(com.qq.java.awt.AlphaComposite.SrcOver);
...
//        }
    ...
    private static long sizeOfDataBuffer(com.qq.java.awt.image.DataBuffer dataBuffer)
    {
    ...
    private static long sizeOfElement(int dataType)
    {
        switch (dataType)
        {
            case com.qq.java.awt.image.DataBuffer.TYPE_BYTE:
                return (Byte.SIZE / 8);
            case com.qq.java.awt.image.DataBuffer.TYPE_DOUBLE:
                return (Double.SIZE / 8);
            case com.qq.java.awt.image.DataBuffer.TYPE_FLOAT:
                return (Float.SIZE / 8);
            case com.qq.java.awt.image.DataBuffer.TYPE_INT:
                return (Integer.SIZE / 8);
            case com.qq.java.awt.image.DataBuffer.TYPE_SHORT:
            case com.qq.java.awt.image.DataBuffer.TYPE_USHORT:
                return (Short.SIZE / 8);
            case com.qq.java.awt.image.DataBuffer.TYPE_UNDEFINED:
                break;
        }
        return 0L;
    }
    ...
    {
        int transparency = com.qq.java.awt.image.BufferedImage.TRANSLUCENT; // TODO: make configurable
