 ...
 *
 * @see com.qq.java.awt.image.BufferedImage
 * 
 * @author dcollins
...
public class BasicColorBlockExtractor implements ColorBlockExtractor
{
    ...
    protected com.qq.java.awt.image.BufferedImage image;
    private int[] buffer;
     ...
     */
    public BasicColorBlockExtractor(com.qq.java.awt.image.BufferedImage image)
    {
        if (image == null)
        {
     ...
     */
    public com.qq.java.awt.image.BufferedImage getImage()
    {
        return this.image;
    }
