...
public class DDSCompressor
{
     ...
     * com.qq.javax.imageio.ImageIO#read(java.io.InputStream)}. Once the <code>stream</code> is read, this is equivalent to
     * calling {#compressImage(com.qq.java.awt.image.BufferedImage, gov.nasa.worldwind.formats.dds.DXTCompressionAttributes)}
        ...
        DXTCompressionAttributes attributes) throws java.io.IOException
    {
        ...
        com.qq.java.awt.image.BufferedImage image = com.qq.javax.imageio.ImageIO.read(inputStream);
        if (image == null)
        {
            return null;
        }
     ...
     * The <code>stream</code> must be readable by {@link com.qq.javax.imageio.ImageIO#read(java.io.InputStream)}. Once the
     * <code>stream</code> is read, this is equivalent to calling {#compressImage(com.qq.java.awt.image.BufferedImage)} with
     ...
     * com.qq.javax.imageio.ImageIO#read(java.io.InputStream)}. Once the image data is read, this is equivalent to calling
     * {#compressImage(com.qq.java.awt.image.BufferedImage, gov.nasa.worldwind.formats.dds.DXTCompressionAttributes)} with the
     ...
     * The bytes in <code>imageBuffer</code> must be readable by {@link com.qq.javax.imageio.ImageIO#read(java.io.InputStream)}.
     * Once the image data is read, this is equivalent to calling {#compressImage(com.qq.java.awt.image.BufferedImage)} with
     ...
     * <code>attributes</code>. The <code>file</code> must be readable by {@link com.qq.javax.imageio.ImageIO#read(java.io.File)}.
     * Once the file is read, this is equivalent to calling {#compressImage(com.qq.java.awt.image.BufferedImage,
        ...
        throws java.io.IOException
    {
        ...
        com.qq.java.awt.image.BufferedImage image = com.qq.javax.imageio.ImageIO.read(file);
        if (image == null)
        {
            return null;
        }
     ...
     * The <code>file</code> must be readable by {@link com.qq.javax.imageio.ImageIO#read(java.io.File)}. Once the file is
     * read, this is equivalent to calling {#compressImage(com.qq.java.awt.image.BufferedImage)} with the BufferedImage created
     ...
     * <code>attributes</code>. The <code>url</code> must be readable by {@link com.qq.javax.imageio.ImageIO#read(java.net.URL)}.
     * Once the <code>url</code> is read, this is equivalent to calling {#compressImage(com.qq.java.awt.image.BufferedImage,
     * gov.nasa.worldwind.formats.dds.DXTCompressionAttributes)} with the BufferedImage created by ImageIO and the
        ...
        throws java.io.IOException
    {
        ...
        com.qq.java.awt.image.BufferedImage image = com.qq.javax.imageio.ImageIO.read(url);
        if (image == null)
        {
            return null;
        }
     ...
     * The <code>url</code> must be readable by {@link com.qq.javax.imageio.ImageIO#read(java.net.URL)}. Once the
     * <code>url</code> is read, this is equivalent to calling {#compressImage(com.qq.java.awt.image.BufferedImage)} with the
     ...
     *                                  dimensions.
     */
    public static java.nio.ByteBuffer compressImage(com.qq.java.awt.image.BufferedImage image)
    {
        if (image == null)
        {
     ...
     */
    public java.nio.ByteBuffer compressImage(com.qq.java.awt.image.BufferedImage image, DXTCompressionAttributes attributes)
    {
        if (image == null)
        {
            String message = Logging.getMessage("nullValue.ImageIsNull");
     ...
     *                                  <code>image</code> has non power of two dimensions.
     */
    public java.nio.ByteBuffer compressImageDXT1(com.qq.java.awt.image.BufferedImage image,
     ...
     *                                  <code>image</code> has non power of two dimensions.
     */
    public java.nio.ByteBuffer compressImageDXT3(com.qq.java.awt.image.BufferedImage image,
        DXTCompressionAttributes attributes)
    {
        if (image == null)
        {
    ...
    protected java.nio.ByteBuffer doCompressImage(DXTCompressor compressor, com.qq.java.awt.image.BufferedImage image,
        DXTCompressionAttributes attributes)
    {
        ...
        // to the DDS header.
        com.qq.java.awt.image.BufferedImage[] mipMapLevels = null;
        int fileSize = 4 + header.getSize();

        if (attributes.isBuildMipmaps())
        {
            mipMapLevels = this.buildMipMaps(image, attributes);
            for (com.qq.java.awt.image.BufferedImage mipMapImage : mipMapLevels)
            {
    ...
    protected DXTCompressor getDXTCompressor(com.qq.java.awt.image.BufferedImage image, DXTCompressionAttributes attributes)
    {
    ...
    protected com.qq.java.awt.image.BufferedImage[] buildMipMaps(com.qq.java.awt.image.BufferedImage image,
        DXTCompressionAttributes attributes)
    {
    ...
    protected DDSHeader createDDSHeader(DXTCompressor compressor, com.qq.java.awt.image.BufferedImage image,
        DXTCompressionAttributes attributes)
    {
