...
public class DXT1Compressor implements DXTCompressor
{
    ...
    public int getCompressedSize(com.qq.java.awt.image.BufferedImage image, DXTCompressionAttributes attributes)
    {
        if (image == null)
        {
    ...
    public void compressImage(com.qq.java.awt.image.BufferedImage image, DXTCompressionAttributes attributes,
    ...
    protected ColorBlockExtractor getColorBlockExtractor(com.qq.java.awt.image.BufferedImage image)
    {
