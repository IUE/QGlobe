...
public class RestorableSupport
{
    ...
    public com.qq.java.awt.Color getStateObjectAsColor(StateObject stateObject)
    {
        String stringValue = getStateObjectAsString(stateObject);
        if (stringValue == null)
            return null;
    ...
    public void addStateValueAsColor(String name, com.qq.java.awt.Color color)
    {
        addStateValueAsColor(null, name, color);
    }

    public void addStateValueAsColor(StateObject context, String name, com.qq.java.awt.Color color)
    {
        if (context != null && !containsElement(context.elem))
        {
            String message = Logging.getMessage("RestorableSupport.InvalidStateObject");
     ...
     */
    public static String encodeColor(com.qq.java.awt.Color color)
    {
        if (color == null)
        {
            String message = Logging.getMessage("nullValue.ColorIsNull");
     ...
     * to {@link #encodeColor(com.qq.java.awt.Color)}. If <code>encodedString</code> cannot be decoded, this method returns
     * null.
     *
     ...
     */
    public static com.qq.java.awt.Color decodeColor(String encodedString)
    {
        ...
        return new com.qq.java.awt.Color(
            (i >> 24) & 0xFF,
            (i >> 16) & 0xFF,
            (i >> 8) & 0xFF,
            i & 0xFF);
