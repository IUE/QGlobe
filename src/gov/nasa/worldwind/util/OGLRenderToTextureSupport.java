...
public class OGLRenderToTextureSupport
{
    ...
    protected com.qq.java.awt.Rectangle drawRegion;
     ...
     */
    public void clear(DrawContext dc, com.qq.java.awt.Color color)
    {
        if (dc == null)
        {
            String message = Logging.getMessage("nullValue.DrawContextIsNull");
    ...
    public void beginRendering(DrawContext dc, int x, int y, int width, int height)
    {
        ...
        this.drawRegion = new com.qq.java.awt.Rectangle(x, y, width, height);
