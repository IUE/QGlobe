...
public class OGLTextRenderer extends TextRenderer
{
    ...
    protected static final com.qq.java.awt.Font DEFAULT_FONT = com.qq.java.awt.Font.decode("Arial-PLAIN-12");
    ...
    public OGLTextRenderer(com.qq.java.awt.Font font, boolean antialiased, boolean useFractionalMetrics,
    ...
    public OGLTextRenderer(com.qq.java.awt.Font font, boolean mipmap)
    {
        this(font, DEFAULT_ANTIALIAS, DEFAULT_USE_FRACTIONAL_METRICS, null, mipmap);
    }

    public OGLTextRenderer(com.qq.java.awt.Font font)
    {
    ...
    public static TextRenderer getOrCreateTextRenderer(TextRendererCache cache,
        com.qq.java.awt.Font font, boolean antialiased, boolean useFractionalMetrics, boolean mipmap)
    {
        if (cache == null)
        {
    ...
    public static TextRenderer getOrCreateTextRenderer(TextRendererCache cache, com.qq.java.awt.Font font)
    {
        if (cache == null)
        {
            String message = Logging.getMessage("nullValue.CacheIsNull");
