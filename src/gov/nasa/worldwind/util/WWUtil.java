...
/**
 * @author tag
 * @version $Id: WWUtil.java 1 2011-07-16 23:22:47Z dcollins $
 */
public class WWUtil
{
    /**
...
//    }
     ...
     * @see #encodeColorABGR(com.qq.java.awt.Color)
     */
    public static String encodeColorRGBA(com.qq.java.awt.Color color)
    {
        if (color == null)
        {
            String message = Logging.getMessage("nullValue.ColorIsNull");
     ...
     * @see #encodeColorRGBA(com.qq.java.awt.Color)
     */
    public static String encodeColorABGR(com.qq.java.awt.Color color)
    {
        if (color == null)
        {
            String message = Logging.getMessage("nullValue.ColorIsNull");
     ...
     * @see #encodeColorRGBA(com.qq.java.awt.Color)
     */
    public static com.qq.java.awt.Color decodeColorRGBA(String encodedString)
    {
     ...
     * @see #encodeColorABGR(com.qq.java.awt.Color)
     */
    public static com.qq.java.awt.Color decodeColorABGR(String encodedString)
    {
        if (encodedString == null)
        {
            String message = Logging.getMessage("nullValue.StringIsNull");
