...
public class OGLUtil
{
    ...
    /**
     * Sets the GL color state to the specified {@link com.qq.java.awt.Color} and opacity, and with the specified color mode.
     ...
     */
    public static void applyColor(GL gl, com.qq.java.awt.Color color, double opacity, boolean premultiplyColors)
    {
        if (gl == null)
        {
            String message = Logging.getMessage("nullValue.GLIsNull");
    ...
    /**
     * Sets the GL color state to the specified {@link com.qq.java.awt.Color}, and with the specified color mode. If
     ...
     *                                  the opacity is greater than 1.
     */
    public static void applyColor(GL gl, com.qq.java.awt.Color color, boolean premultiplyColors)
    {
        if (gl == null)
        {
            String message = Logging.getMessage("nullValue.GLIsNull");
